...
('2026AA00001', 'AA100AA', '2020-05-12', '2020-05-12', 1, TRUE, 3, 'JHMFC26520S000001', 1300, 1800, 'B', 'Essence', 1498, 182, 12, 5, 0, 128, 'Euro 6d', 72, 6200, 'Blanc', '2030-05-12', '2024-05-12', '2030-05-12', '2024-05-12'),
-- Honda CB500F (Deux roues - A2) - ID Modele: 1
('2026AA00002', 'AA100AB', '2021-06-15', '2021-06-15', 2, TRUE, 1, 'JH2PC4505LM000001', 190, 370, 'A2', 'Essence', 471, 48, 35, 2, 0, 80, 'Euro 5', 95, 8500, 'Rouge', '2031-06-15', '2024-06-15', '2031-06-15', '2024-06-15'),
-- Peugeot 208 (Automobile - B) - ID Modele: 9
('2026AA00003', 'AA100AC', '2022-03-20', '2022-03-20', 3, TRUE, 9, 'VF3C5HT00NS000001', 1050, 1550, 'B', 'Essence', 1199, 100, 8, 5, 0, 102, 'Euro 6d', 70, 5800, 'Bleu', '2032-03-20', '2025-03-20', '2032-03-20', '2026-03-20'),
-- Peugeot Boxer 440 (Camion léger - C) - ID Modele: 11
('2026AA00004', 'AA100AD', '2021-11-05', '2021-11-05', 4, TRUE, 11, 'VF3E4HY00MS000001', 2100, 4400, 'C', 'Diesel', 2179, 140, 8, 3, 0, 230, 'Euro 6d', 74, 3500, 'Blanc', '2031-11-05', '2024-11-05', '2031-11-05', '2025-11-05'),
-- Renault Clio (Automobile - B) - ID Modele: 15
('2026AA00005', 'AA100AE', '2023-01-10', '2023-01-10', 5, TRUE, 15, 'VF1RJ2A0P62000001', 1100, 1600, 'B', 'Essence', 999, 90, 6, 5, 0, 110, 'Euro 6d', 68, 5500, 'Gris', '2033-01-10', '2026-01-10', '2033-01-10', '2027-01-10'),
-- Renault Master (Camion léger - C) - ID Modele: 17
('2026AA00006', 'AA100AF', '2020-08-22', '2020-08-22', 6, TRUE, 17, 'VF1MA2A0L52000001', 2200, 3500, 'C', 'Diesel', 2299, 135, 8, 3, 0, 240, 'Euro 6d', 75, 3800, 'Jaune', '2030-08-22', '2024-08-22', '2030-08-22', '2025-08-22'),
-- Mercedes Classe A (Automobile - B) - ID Modele: 21
('2026AA00007', 'AA100AG', '2024-04-15', '2024-04-15', 1, TRUE, 21, 'WDD1770361A000001', 1400, 1950, 'B', 'Essence', 1332, 140, 10, 5, 0, 130, 'Euro 6d', 69, 6000, 'Noir', '2034-04-15', '2027-04-15', '2034-04-15', '2028-04-15'),
-- Mercedes Sprinter 5t (Camion léger - C) - ID Modele: 23
('2026AA00008', 'AA100AH', '2021-02-28', '2021-02-28', 2, TRUE, 23, 'WDB9066361L000001', 2600, 5000, 'C', 'Diesel', 2143, 163, 9, 3, 0, 215, 'Euro 6d', 73, 3600, 'Argent', '2031-02-28', '2024-02-28', '2031-02-28', '2025-02-28'),
-- Iveco Daily 35C (Camion léger - C) - ID Modele: 29
('2026AA00009', 'AA100AI', '2022-10-12', '2022-10-12', 3, TRUE, 29, 'ZCFC353B000000001', 2200, 3500, 'C', 'Diesel', 2998, 160, 10, 3, 0, 225, 'Euro 6d', 76, 4000, 'Blanc', '2032-10-12', '2025-10-12', '2032-10-12', '2026-10-12'),
-- Iveco Turbo Bike (Deux roues - A) - ID Modele: 26
('2026AA00010', 'AA100AJ', '2023-05-30', '2023-05-30', 4, TRUE, 26, 'ZCFM125B000000001', 250, 450, 'A', 'Essence', 998, 120, 80, 2, 0, 110, 'Euro 5', 98, 9000, 'Orange', '2033-05-30', '2026-05-30', '2033-05-30', '2027-05-30'),
-- Ford Fiesta (Automobile - B) - ID Modele: 33
('2026AA00011', 'AA100AK', '2020-12-01', '2020-12-01', 5, TRUE, 33, 'WF0AXXGAJAXK00001', 1150, 1650, 'B', 'Essence', 999, 95, 7, 5, 0, 115, 'Euro 6d', 67, 5400, 'Vert', '2030-12-01', '2023-12-01', '2030-12-01', '2024-12-01'),
-- Ford Transit 470 (Camion léger - C) - ID Modele: 36
('2026AA00012', 'AA100AL', '2021-07-18', '2021-07-18', 6, TRUE, 36, 'WF0XXXTTFXGX00001', 2800, 4700, 'C', 'Diesel', 1995, 170, 11, 3, 0, 245, 'Euro 6d', 77, 4200, 'Bleu', '2031-07-18', '2024-07-18', '2031-07-18', '2025-07-18');
