...
def add_carte_grise():
    ...
    DONNEES_TECHNIQUES_REF = {
        # Honda
        1: {'pv': 190, 'pm': 370, 'permis': 'A2', 'pl': 2, 'cyl': 471, 'cv': 48, 'co2': 80, 'classe': 'Euro 5', 'cv_admin': 6, 'pl_debout': 0, 'db': 95, 'rpm': 8500},   # CB500F
        2: {'pv': 201, 'pm': 390, 'permis': 'A', 'pl': 2, 'cyl': 999, 'cv': 217, 'co2': 160, 'classe': 'Euro 4', 'cv_admin': 15, 'pl_debout': 0, 'db': 105, 'rpm': 13000},  # CBR1000RR
        3: {'pv': 1300, 'pm': 1800, 'permis': 'B', 'pl': 5, 'cyl': 1498, 'cv': 182, 'co2': 128, 'classe': 'Euro 6d', 'cv_admin': 9, 'pl_debout': 0, 'db': 72, 'rpm': 6500}, # Civic
        4: {'pv': 1600, 'pm': 2200, 'permis': 'B', 'pl': 5, 'cyl': 1993, 'cv': 184, 'co2': 153, 'classe': 'Euro 6d', 'cv_admin': 10, 'pl_debout': 0, 'db': 75, 'rpm': 6000}, # CR-V
        5: {'pv': 2800, 'pm': 4500, 'permis': 'C', 'pl': 3, 'cyl': 2999, 'cv': 150, 'co2': 210, 'classe': 'Euro 6', 'cv_admin': 12, 'pl_debout': 0, 'db': 78, 'rpm': 4500}, # NT400
        6: {'pv': 2600, 'pm': 3500, 'permis': 'C', 'pl': 3, 'cyl': 2488, 'cv': 130, 'co2': 220, 'classe': 'Euro 6', 'cv_admin': 11, 'pl_debout': 0, 'db': 76, 'rpm': 4200}, # Cabstar
        # Peugeot
        7: {'pv': 95, 'pm': 270, 'permis': 'A1', 'pl': 2, 'cyl': 49, 'cv': 4, 'co2': 45, 'classe': 'Euro 5', 'cv_admin': 1, 'pl_debout': 0, 'db': 82, 'rpm': 8000},     # Kisbee
        8: {'pv': 280, 'pm': 450, 'permis': 'A', 'pl': 2, 'cyl': 399, 'cv': 36, 'co2': 89, 'classe': 'Euro 5', 'cv_admin': 5, 'pl_debout': 0, 'db': 88, 'rpm': 7500},    # Metropolis
        9: {'pv': 1050, 'pm': 1550, 'permis': 'B', 'pl': 5, 'cyl': 1199, 'cv': 100, 'co2': 102, 'classe': 'Euro 6d', 'cv_admin': 7, 'pl_debout': 0, 'db': 70, 'rpm': 6200}, # 208
        10: {'pv': 1500, 'pm': 2100, 'permis': 'B', 'pl': 7, 'cyl': 1598, 'cv': 180, 'co2': 140, 'classe': 'Euro 6d', 'cv_admin': 9, 'pl_debout': 0, 'db': 73, 'rpm': 6000},# 5008
        11: {'pv': 2100, 'pm': 4400, 'permis': 'C', 'pl': 3, 'cyl': 2179, 'cv': 140, 'co2': 230, 'classe': 'Euro 6', 'cv_admin': 11, 'pl_debout': 0, 'db': 77, 'rpm': 4000},# Boxer
        12: {'pv': 1800, 'pm': 3100, 'permis': 'C', 'pl': 3, 'cyl': 1997, 'cv': 145, 'co2': 190, 'classe': 'Euro 6', 'cv_admin': 10, 'pl_debout': 0, 'db': 75, 'rpm': 4500},# Expert
       
       # RENAULT (IDs 13 à 18)
        13: {'pv': 120, 'pm': 300, 'permis': 'A1', 'pl': 2, 'cyl': 124, 'cv': 11, 'co2': 55, 'classe': 'Euro 5', 'cv_admin': 2, 'pl_debout': 0, 'db': 85, 'rpm': 9000, 'couleur': 'Rouge'},     # Full 125
        14: {'pv': 160, 'pm': 340, 'permis': 'A2', 'pl': 2, 'cyl': 395, 'cv': 30, 'co2': 75, 'classe': 'Euro 5', 'cv_admin': 4, 'pl_debout': 0, 'db': 90, 'rpm': 8000, 'couleur': 'Jaune'},     # Sport 400
        15: {'pv': 1100, 'pm': 1600, 'permis': 'B', 'pl': 5, 'cyl': 999, 'cv': 90, 'co2': 110, 'classe': 'Euro 6d', 'cv_admin': 6, 'pl_debout': 0, 'db': 69, 'rpm': 6500, 'couleur': 'Gris'},   # Clio
        16: {'pv': 1400, 'pm': 1950, 'permis': 'B', 'pl': 5, 'cyl': 1332, 'cv': 140, 'co2': 130, 'classe': 'Euro 6d', 'cv_admin': 8, 'pl_debout': 0, 'db': 71, 'rpm': 6200, 'couleur': 'Bleu'}, # Austral
        17: {'pv': 2200, 'pm': 3500, 'permis': 'C', 'pl': 3, 'cyl': 2299, 'cv': 135, 'co2': 240, 'classe': 'Euro 6', 'cv_admin': 11, 'pl_debout': 0, 'db': 76, 'rpm': 4200, 'couleur': 'Jaune'}, # Master
        18: {'pv': 2400, 'pm': 4500, 'permis': 'C', 'pl': 3, 'cyl': 2488, 'cv': 140, 'co2': 250, 'classe': 'Euro 6', 'cv_admin': 12, 'pl_debout': 0, 'db': 78, 'rpm': 4000, 'couleur': 'Blanc'}, # Maxity

       # MERCEDES (19-24)
        19: {'pv': 130, 'pm': 310, 'permis': 'A1', 'pl': 2, 'cyl': 125, 'cv': 12, 'co2': 60, 'classe': 'Euro 5', 'cv_admin': 2, 'pl_debout': 0, 'db': 83, 'rpm': 9500, 'couleur': 'Argent'},   # Citan Scooter
        20: {'pv': 210, 'pm': 400, 'permis': 'A', 'pl': 2, 'cyl': 998, 'cv': 200, 'co2': 155, 'classe': 'Euro 4', 'cv_admin': 14, 'pl_debout': 0, 'db': 102, 'rpm': 12500, 'couleur': 'Noir'},  # Vision GT
        21: {'pv': 1350, 'pm': 1900, 'permis': 'B', 'pl': 5, 'cyl': 1461, 'cv': 116, 'co2': 120, 'classe': 'Euro 6d', 'cv_admin': 7, 'pl_debout': 0, 'db': 68, 'rpm': 6800, 'couleur': 'Noir'}, # Classe A
        22: {'pv': 1800, 'pm': 2400, 'permis': 'B', 'pl': 5, 'cyl': 1993, 'cv': 190, 'co2': 160, 'classe': 'Euro 6d', 'cv_admin': 10, 'pl_debout': 0, 'db': 74, 'rpm': 6200, 'couleur': 'Argent'}, # GLC
        23: {'pv': 2600, 'pm': 5000, 'permis': 'C', 'pl': 3, 'cyl': 2143, 'cv': 163, 'co2': 215, 'classe': 'Euro 6', 'cv_admin': 13, 'pl_debout': 0, 'db': 79, 'rpm': 4500, 'couleur': 'Argent'}, # Sprinter 5t
        24: {'pv': 2900, 'pm': 4800, 'permis': 'C', 'pl': 3, 'cyl': 4250, 'cv': 170, 'co2': 230, 'classe': 'Euro 6', 'cv_admin': 14, 'pl_debout': 0, 'db': 81, 'rpm': 3800, 'couleur': 'Blanc'}, # Vario

        # IVECO (25-30)
        25: {'pv': 150, 'pm': 330, 'permis': 'A2', 'pl': 2, 'cyl': 300, 'cv': 28, 'co2': 70, 'classe': 'Euro 5', 'cv_admin': 3, 'pl_debout': 0, 'db': 87, 'rpm': 8500, 'couleur': 'Orange'},    # Daily Moto
        26: {'pv': 220, 'pm': 420, 'permis': 'A', 'pl': 2, 'cyl': 1100, 'cv': 210, 'co2': 165, 'classe': 'Euro 4', 'cv_admin': 15, 'pl_debout': 0, 'db': 106, 'rpm': 12000, 'couleur': 'Orange'},   # Turbo Bike
        27: {'pv': 2000, 'pm': 2800, 'permis': 'B', 'pl': 5, 'cyl': 2998, 'cv': 176, 'co2': 200, 'classe': 'Euro 6', 'cv_admin': 10, 'pl_debout': 0, 'db': 76, 'rpm': 5500, 'couleur': 'Vert'}, # Massif
        28: {'pv': 1900, 'pm': 2600, 'permis': 'B', 'pl': 5, 'cyl': 2500, 'cv': 150, 'co2': 190, 'classe': 'Euro 6', 'cv_admin': 9, 'pl_debout': 0, 'db': 74, 'rpm': 5800, 'couleur': 'Bleu'}, # Campagnola
        29: {'pv': 2200, 'pm': 3500, 'permis': 'C', 'pl': 3, 'cyl': 2300, 'cv': 140, 'co2': 225, 'classe': 'Euro 6', 'cv_admin': 11, 'pl_debout': 0, 'db': 77, 'rpm': 4300, 'couleur': 'Blanc'}, # Daily 35C
        30: {'pv': 2500, 'pm': 5000, 'permis': 'C', 'pl': 3, 'cyl': 2998, 'cv': 180, 'co2': 245, 'classe': 'Euro 6', 'cv_admin': 13, 'pl_debout': 0, 'db': 80, 'rpm': 4000, 'couleur': 'Rouge'}, # Daily 50C

        # FORD (31-36)
        31: {'pv': 115, 'pm': 290, 'permis': 'A1', 'pl': 2, 'cyl': 125, 'cv': 10, 'co2': 50, 'classe': 'Euro 5', 'cv_admin': 2, 'pl_debout': 0, 'db': 84, 'rpm': 9200, 'couleur': 'Bleu'},    # Street 125
        32: {'pv': 170, 'pm': 360, 'permis': 'A2', 'pl': 2, 'cyl': 450, 'cv': 35, 'co2': 78, 'classe': 'Euro 5', 'cv_admin': 4, 'pl_debout': 0, 'db': 89, 'rpm': 8200, 'couleur': 'Vert'},    # Ranger Bike
        33: {'pv': 1150, 'pm': 1650, 'permis': 'B', 'pl': 5, 'cyl': 999, 'cv': 95, 'co2': 115, 'classe': 'Euro 6d', 'cv_admin': 6, 'pl_debout': 0, 'db': 70, 'rpm': 6400, 'couleur': 'Vert'},   # Fiesta
        34: {'pv': 1300, 'pm': 1850, 'permis': 'B', 'pl': 5, 'cyl': 1498, 'cv': 120, 'co2': 125, 'classe': 'Euro 6d', 'cv_admin': 8, 'pl_debout': 0, 'db': 72, 'rpm': 6300, 'couleur': 'Gris'}, # Focus
        35: {'pv': 2100, 'pm': 3500, 'permis': 'C', 'pl': 3, 'cyl': 1995, 'cv': 130, 'co2': 210, 'classe': 'Euro 6', 'cv_admin': 10, 'pl_debout': 0, 'db': 75, 'rpm': 4600, 'couleur': 'Blanc'}, # Transit 350
        36: {'pv': 2800, 'pm': 4700, 'permis': 'C', 'pl': 3, 'cyl': 1995, 'cv': 170, 'co2': 245, 'classe': 'Euro 6', 'cv_admin': 12, 'pl_debout': 0, 'db': 78, 'rpm': 4400, 'couleur': 'Bleu'}, # Transit 470
    }
               ...
               # 1. Nettoyage des données (Sécurité)
                ...
                insert_carte = """
                    INSERT INTO cartes_grises (
                        ...
                        cylindree_cm3, puissance_chevaux, puissance_administrative_cv,
        ...
        try:
            ...
            update_query = """
                ...
                SET proprietaire_id=%s, modele_id=%s, date_premiere_immat=%s, categorie_permis=%s,
                    poids_vide_kg=%s, poids_max_kg=%s, places_assises=%s, places_debout=%s,
